...
parser.add_argument('-p', dest = 'prefix', required=True, help = 'output file name prefix.')
parser.add_argument('-d', dest = 'output_dir', default = './', help = 'output directory')
parser.add_argument('-t', dest = 'threads', default = 1, type=int, help = 'number of threads, when thread >= layers, running time is remarkably reduced but memory-intensive')
