...
parser.add_argument('-r', dest = 'restrictionFile', required=True, help = 'path to chrom.sizes file')
...
parser.add_argument('-t', dest = 'thread', type=int, default = 1, help = 'number of threads, when t>=n, running time is remarkably reduced but memory-intensive.')
