...
parser.add_argument('-i', dest = 'hicFile', required=True, help = 'Path to a input ".hic" file')
...
parser.add_argument('-p', dest = 'prefix', default = 'HiCORE', help = 'Output file name prefix, {prefix}.matrix.txt will be created')
